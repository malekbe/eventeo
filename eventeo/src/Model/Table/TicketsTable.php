 ...
 * Tickets Model
 *
 * @property \App\Model\Table\SpectatorsTable|\Cake\ORM\Association\BelongsTo $Spectators
 *
...
class TicketsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->allowEmptyString('cena', false);

        $validator
            ->decimal('koszt')
            ->requirePresence('koszt', 'create')
            ->allowEmptyString('koszt', false);

        $validator
            ->integer('ilosc')
            ->requirePresence('ilosc', 'create')
            ->allowEmptyString('ilosc', false);

        $validator
            ->integer('typ')
            ->requirePresence('typ', 'create')
            ->allowEmptyString('typ', false);
    ...
    {
        $rules->add($rules->existsIn(['spectator_id'], 'Spectators'));
